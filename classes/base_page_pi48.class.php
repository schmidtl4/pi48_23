<?php
	...
	class base_page_pi48
    {
        ...
        {
            $briia = 'https://briia.io';
            $tia = 'https://tia.briia.io';

            $host = $_SERVER['HTTP_HOST'];
            dbg(__CLASS__.' | '.__FUNCTION__.' | '.__LINE__.' | $host', $host );

            if ($host == 'tia.briia' || $host == 'briia') {
                $briia = 'http://briia';
                $tia = 'http://tia.briia';

            } elseif ($host == 'tia-staging.briia.io') {
                $briia = 'http://staging.briia.io';
                $host = 'https://tia-staging.briia.io';
            }

            $advMenu = self::setAdvancedMenu();

            $fndMenu = self::setFoundationMenu();
                ...
                /*case 'advanced_program':
                   ...
                   <div class="container subnav text-center" id="subnav">
                       ...
                       <ul style="display:inline;">
                            ...
                            <li class="menu-item">
                               <a href="https://briia.io" id="briia_home">BRIIA</a>
                           </li>
        ...
        //SET ADVANCED MENU
        private static function setAdvancedMenu(): string
        {
            return '
            <a href="" data-toggle="dropdown"
                aria-expanded="false" class="dropdown-toggle"
                id="dropdownMenuLink" aria-haspopup="true">Advanced Programs</a>
                
            <ul class="list-unstyled dropdown-menu"
            aria-labelledby="dropdownMenuLink">
                <li>
                    <a class="dropdown-item" href="/advanced_genai" data-autohide="menu_genai" >Business AI</a>
                </li>
                
                <li>
                     <a class="dropdown-item" href="/advanced_hcai" id="menu_hcai" >Healthcare AI</a>
                </li>
                
                <li >
                    <a class="dropdown-item" href="/advanced_apply" id="menu_adv_apply" target="_blank">How to Apply</a>
                </li>
                
                <li>
                    <a class="dropdown-item" href="/advanced_registration" id="menu_register" target="_blank">Registration</a>
                </li>
                
                <li>
                    <a class="dropdown-item" id="menu_foundation_about"
                     href="tia_app/faqs" >More details</a>
                </li>
        ...
        //SET FOUNDATION MENU
        private static function setFoundationMenu(): string
        {
            return '
            <a href="" data-toggle="dropdown"
                aria-expanded="false" class="dropdown-toggle"
                id="dropdownMenuLink1" aria-haspopup="true">Foundation Program</a>
                
            <ul class="list-unstyled dropdown-menu"
            aria-labelledby="dropdownMenuLink1">
            
                <li>
                    <a class="dropdown-item" id="menu_foundation"
                     href="/">Overview</a>
                </li>
                <li>
                    <a class="dropdown-item" id="menu_foundation_about"
                     href="/tia_app/faqs" target="_blank">More details</a>
                </li>
                <li>
                    <a class="dropdown-item" id="menu_start_journey"
                     href="/tia_app/tia_gps_profile" data-autohide="menu_genai" target="_blank">Start my Journey</a>
                </li>
                
                <li>
                     <a class="dropdown-item" id="menu_tia_login"
                      href="/login" target="_blank">Login</a>
                </li>
            </ul>';
        }
        ...
        private static function setFlyoutMenu($mode='foundation_program'):string
        {
            ...
            } elseif ($thost = 'tia-staging.briia.io') {
                $briia = 'http://staging.briia.io';
                $host = 'https://tia-staging.briia.io';
            }
        ...
        {
			return '
			<link href="/css/tia.css" rel="stylesheet">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                ...
                                <address class="">&copy; 2017 - '.$dt->format('Y').' BRIIA, Inc. &nbsp; </address>
		...
		public static function set_bottom_js($js_css): string
        {
			...
			if ($js_css['navLocation'] == "SIDE") {
				$mScrollScript = '
				<script src="/js/mCustomScroll/jquery.mCustomScrollbar.concat.min.js"></script>';
				$mScroll = '
