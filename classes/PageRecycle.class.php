<?php
	...
	class PageRecycle extends BasePage {
		...
		static function setBody(): string
        {
            ...
            <div class="container page-container">
                ...
                <div class="row" >
                    <div class="col p-0">
                        <img src="/_images/garbage-recycling_750x200.jpg" class="img-fluid">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="web-title">
                            <h2 style="margin: 10px 0; padding-top: 5px;">Recycling and trash
                            </h2>
                        </div>
                        <div class="print-title" id="printTitle"></div>
                    </div>
